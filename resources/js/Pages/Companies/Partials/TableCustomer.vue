<template>
    <div>
        <div class="card">
            <Toolbar class="mb-4 border border-slate-200 ...">
                <template #start>
                    ...
                    <Button label="Eliminar" icon="pi pi-trash" severity="danger" class="danger-button" @click="confirmDeleteSelected" :disabled="!selectedCompanies || !selectedCompanies.length" />
                </template>
            </Toolbar>
        ...
        <!-- MODAL -->
        <Dialog v-model:visible="companyDialog" :header="company.id ? 'Modificar cliente' : 'Crear cliente'" id="titleCompany" :modal="true" class="p-fluid">
            ...
            <form style="width: 800px;" @submit.prevent="saveCompany">
                ...
                <div>
                    ...
                    <div>
                        <label for="tax_number" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">CIF</label>
        ...
        <Dialog v-model:visible="deleteCompanyDialog" :style="{width: '450px'}" header="Confirm" :modal="true">
            <div class="confirmation-content">
                ...
                <span v-if="company">¿Deseas eliminar <b>{{company.name}}</b>?</span>
            </div>
            <template #footer>
        ...
        <Dialog v-model:visible="deleteCompaniesDialog" :style="{width: '450px'}" header="Confirm" :modal="true">
            <div class="confirmation-content">
                <i class="pi pi-exclamation-triangle mr-3" style="font-size: 2rem" />
                <span v-if="company">¿Deseas eliminar los clientes selecciondos?</span>
            </div>
            <template #footer>
