                ...
                <div class="flex justify-end mt-4 pr-4 mb-4">
                    <div class="totals-container w-1/3">
                        <div class="totals p-4 rounded-md">
                            <div class="totals-item flex justify-between">
                                <span class="mr-4">{{ $t('Subtotal (excluding Tax)') }}:</span>
                                <span>{{ subtotal.toFixed(2) }}€</span>
                            </div>
                            <hr> 
                            <div class="totals-item flex justify-between">
                                <span class="mr-4">{{ $t('Total Tax') }}:</span>
                                <span>{{ totalIVA.toFixed(2) }}€</span>
                            </div>
                            <hr>  
                            <div class="totals-item flex justify-between total">
                                <span class="mr-4">{{ $t('Total (with IVA)') }}:</span>
                                <span>{{ totalConIVA.toFixed(2) }}€</span>
                            </div>
                        </div>
                    </div>
