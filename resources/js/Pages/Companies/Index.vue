        ...
        <div class="py-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-lg">
                    ...
                    <NewCompany v-else-if="showNewCompany && !isLoading" @getStartedClicked="showTable" />
                    <div v-if="isLoading">
                        <div role="status">
    ...
    export default {
        ...
        methods: {
            checkCompanyExistence() {
                axios.get('/has-company')
                    .then(response => {
                        // Actualiza el estado de la empresa basado en la respuesta del servidor
            ...
            showTable() {
            // Método para mostrar la tabla cuando se hace clic en el botón "Get started"
        ...
        mounted() {
            // Llama al método checkCompanyExistence() cuando el componente se monta
            this.checkCompanyExistence();
        }
    };
</script>